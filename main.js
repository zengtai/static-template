...
if (pathname.endsWith("/index.html") || pathname.endsWith("/")) {
  ...
  var TopGames = function TopGames() {
    ...
    topgames.forEach(function (item) {
      ...
      li.setAttribute("class", "top-list-item");
